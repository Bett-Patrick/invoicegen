...
//import PaymentMethod from '../InvoiceEdit/components/Payments/PaymentMethod';
...
const InvoicePreview = () => {
  ...
  return (
    <div className="flex flex-col bg-white w-full h-auto p-4 md:p-10 shadow-lg">
      ...
      <div className="item-center mt-10 items-center justify-center">
        <p className="font-semibold text-center">Payment Method</p>
        <Divider className="p-0 m-1"/>
        <div className=" flex w-full my-2 text-center fontfamily-poppins  text-black font-bold">{forminfo.methods}</div>
      <div className=" flex w-full my-2 text-center  text-gray-700 font-bold">Account Name: 
      <span className="mx-8 uppercase font-oswald antialiased text-green-600">
      {forminfo.accname}
      </span></div>
      <div className=" flex w-full my-2 text-center  text-gray-700 font-bold">Account Number:
      <span className="mx-5 text-red-600">
      {forminfo.account}
      </span></div>
      </div>
      <div className=" flex w-full my-10">{forminfo.notes}</div>
